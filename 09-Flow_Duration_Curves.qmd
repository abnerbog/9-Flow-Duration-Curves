...
As always let's load the packages we will use: tidyverse, dataRetrieval, and patchwork. Patchwork will help us make a multi-panel graph in the last part of the exercise.
...
> Pass our Qdat data to mutate and create a new column that is equal to the ranks of the flow column. 
